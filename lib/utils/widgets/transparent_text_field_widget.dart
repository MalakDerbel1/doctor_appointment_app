  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: 'Search',
        hintStyle:
            TextStyle(color: Colors.white.withOpacity(0.7)), // Hint style
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
              color: Colors.white
                  .withOpacity(0.5)), // Border color for enabled state
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(30),
          borderSide:
              BorderSide(color: Colors.white), // Border color for focused state
        ),
      ),
    );
  }
