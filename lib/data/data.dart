...
List<DoctorModel> doctorList = [
  ...
  DoctorModel(
    ...
    totalReviews: 332,
    about:
        "Dr. Jenny Wilson is the top most immunologist specialist at Vcare Clinic in London, UK.",
    rating: 4.9,
    experience: "7+ years",
    patients: 120,
    isFav: false,
  ...
  DoctorModel(
    ...
    totalReviews: 150,
    about:
        "Dr. John Smith specializes in treating various fevers and has a proven track record.",
    rating: 4.8,
    experience: "10+ years",
    patients: 200,
    isFav: false,
  ...
  DoctorModel(
    ...
    totalReviews: 245,
    about:
        "Dr. Emily Davis is an expert in respiratory issues and has helped countless patients.",
    rating: 4.7,
    experience: "8+ years",
    patients: 180,
    isFav: false,
  ...
  DoctorModel(
    ...
    totalReviews: 320,
    about:
        "Dr. Michael Brown specializes in digestive disorders and is highly recommended.",
    rating: 4.9,
    experience: "12+ years",
    patients: 300,
    isFav: false,
  ...
  DoctorModel(
    ...
    totalReviews: 400,
    about:
        "Dr. Sarah Johnson is a renowned dentist with expertise in cosmetic dentistry.",
    rating: 4.6,
    experience: "9+ years",
    patients: 250,
    isFav: false,
  ...
  DoctorModel(
    ...
    totalReviews: 280,
    about:
        "Dr. Esther is a renowned dentist with expertise in cosmetic dentistry.",
    rating: 4.5,
    experience: "7+ years",
    patients: 110,
    isFav: true,
  ...
  DoctorModel(
    ...
    totalReviews: 350,
    about:
        "Dr. Alice Green is a family medicine specialist focusing on overall wellness.",
    rating: 4.7,
    experience: "6+ years",
    patients: 150,
    isFav: false,
